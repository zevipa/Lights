...
class Lights(QtGui.QWidget):
    ...
    def createBlocks(self):
        ...
        self.light = QtGui.QPixmap("images/light.png")
        self.dark = QtGui.QPixmap("images/dark.png")
    ...
    def initUi(self):
        ...
        self.setWindowIcon(QtGui.QIcon('images/LightsIcon16.png'))
        self.show()
    ...
    def check(self):
        ...
        if self.blck1Light == 1 and \
			self.blck2Light == 1 and \
			self.blck3Light == 1 and \
			self.blck4Light == 1 and \
			self.blck5Light == 1 and \
			self.blck6Light == 1 and \
			self.blck7Light == 1 and \
